...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.mipmap.bk, "Burger King", "Realiza tu pedido"));
        items.add(new ItemsList(R.mipmap.dominos, "Dominos Pizza", "Realiza tu pedido"));
        items.add(new ItemsList(R.mipmap.mcdonals, "MCdonals", "Realiza tu pedido"));
        items.add(new ItemsList(R.mipmap.starbuks, "Starbucks", "Realiza tu pedido"));
        items.add(new ItemsList(R.mipmap.kfc, "KFC", "Realiza tu pedido"));
